import{$ as e,$t as t,Lt as n,St as r,Xt as i,Yt as a,gn as o,rn as s,tn as c,tt as l,ut as u}from"./vendor-three-eZ8ECXpj.js";var d=[1e3,1e4,5e4,1e5],f=60,p=300,m=600,h=220;function g(){return new u(4,4,4)}function _(e,t){let n=t=>{let n=Math.sin((e+1)*12.9898+t*78.233)*43758.5453;return n-Math.floor(n)};return[(n(1)*2-1)*m,(n(2)*2-1)*m,(n(3)*2-1)*m]}function v(e,t,n,r){let a=[];for(let o=0;o<r;o++){let s=new i(t,n),[c,l,u]=_(o,r);s.position.set(c,l,u),s.updateMatrix(),s.matrixAutoUpdate=!1,e.add(s),a.push(s)}return{dispose:()=>a.forEach(t=>e.remove(t))}}function y(e,t,r,i){let a=new n(t,r,i);a.frustumCulled=!1;let o=new c;for(let e=0;e<i;e++){let[t,n,r]=_(e,i);o.position.set(t,n,r),o.updateMatrix(),a.setMatrixAt(e,o.matrix)}return a.instanceMatrix.needsUpdate=!0,e.add(a),{dispose:()=>e.remove(a)}}var b=`
